...
public class MyAppsFlyerScript : MonoBehaviour, IAppsFlyerConversionData
{
    ...
    public static MyAppsFlyerScript facebook;
    ...
    FacebookDelegate<IAppLinkResult> callback;// = new FacebookDelegate<IAppLinkResult>();
    //public FacebookDelegate<IAppLinkResult> GetDelegate1()
    //{
    //    var sample1 = FacebookDelegate();
    //}
private void onSDKStarted(){
     AppsFlyer.OnRequestResponse += (sender, args) =>
    {
        ...
        print(af_args.errorDescription);
    ...
    if(disableSKAd)
        ...
        if (useUDL)
        {
            ...
            print("AppsFlyer.OnDeepLinkReceived");
        }
 ...
 void OnDeepLink(object sender, EventArgs args)
    {
        ...
        print(deepLinkEventArgs.status.ToString());
