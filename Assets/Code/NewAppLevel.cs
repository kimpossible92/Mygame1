...
public class NewAppLevel : MonoBehaviour
{
    ...
    public void nazad2()
    {
        ...
        GetMove2.gameObject.SetActive(false);
    ...
    public void OnappMatch()
    {
        ...
        else if (modeLvl == 2)
        {
            ...
            //GetMove2.IngredientPosition(ingCtar[0], ingCtar[1]);
        ...
        else if (modeLvl == 1)
        {
            ...
            if ((uint)ltype == 1 && GetMove2.state == 0)
            {
                //ISNULL = false;
    ...
    public void openLeveltxt(string mapText)
    {
        ...
        foreach (string line in lines)
        {
            ...
            else if (line.StartsWith("SIZE"))
            {
                ...
                MaxY = 6;//int.Parse(sizes[1]);
                GetMove2.loadSize(MaxX, MaxY);//
                Arrays.THIS.SizeX = int.Parse(sizes[0]);
                Arrays.THIS.SizeY = 6;//int.Parse(sizes[1]);
